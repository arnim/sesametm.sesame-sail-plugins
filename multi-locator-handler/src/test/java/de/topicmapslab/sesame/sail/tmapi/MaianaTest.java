...
public class MaianaTest extends TestCase {
	...
	public void testSPx() throws Exception {
		...
		String queryString = "PREFIX wiki: <http://en.wikipedia.org/wiki/>  " +
		" CONSTRUCT { <http://en.wikipedia.org/wiki/Germany> <http://en.wikipedia.org/wiki/Population> ?O }" +
		"WHERE { <http://en.wikipedia.org/wiki/Germany> <http://en.wikipedia.org/wiki/Population> ?O }";		
